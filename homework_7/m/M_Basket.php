...
class M_Basket
{
    ...
    static function buy($n,$s,$a,$g,$c){
        $sid= session_id();
        M_PDO::insert("INSERT INTO orders(name, surname, address, goods_id, count) VALUES (:name, :surname, :address, :goods_id, :count)",
            [':name'=> $n, ':surname'=>$s, ':address'=>$a, ':goods_id'=>$g, 'count' => $c]);
